...
knitr::include_graphics("module_3/tidy_data_figure_R4DS.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="70%"}
knitr::include_graphics("module_3/tidy_pivot_longer_R4DS.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="70%"}
knitr::include_graphics("module_3/tidy_pivot_wider_R4DS.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="70%"}
knitr::include_graphics("module_3/tidy_data_separate_R4DS.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="70%"}
knitr::include_graphics("module_3/tidy_data_unite_R4DS.png")
```
