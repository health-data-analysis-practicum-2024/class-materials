...
* Small lecture on reading in ASCII data and merging data sets
* Questions and work time


### Reading in data from an ASCII file
```{r}

library(asciiSetupReader)


femalepreg_data = read_ascii_setup(
  "module_3/data/2017_2019_FemPregData.dat",
  "module_3/data/2017_2019_FemPregSetup.sps",
...
* Submit your assignment in R markdown through Github **by Sunday (April 7, 2024) at midnight**.  You can find a link to create your final project repository in Github on Blackboard.
